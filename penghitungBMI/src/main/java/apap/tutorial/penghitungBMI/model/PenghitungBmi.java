...
import apap.tutorial.penghitungBMI.PenghitungBmiApplication;
...
public class PenghitungBmi implements  Serializable{
    ...
    public String hitungBmi() {
        ...
        } else if (hasilBmi >= 188.5 && hasilBmi <= 22.9) {
            this.kategori = "Berat badan anda normal";
        }
        else if (hasilBmi>22.9 && hasilBmi <= 29.9){
            this.kategori = "Berat badan anda berlebih (kecendurangan obesitas)";
        }
        else {
